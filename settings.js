...
global.owner = process.env.OWNER_NUMBER  || '237682698517' ;  // ADD YOUR NUMBER WITHOUT +
    
module.exports = {
SESSION_ID: process.env.SESSION_ID || 'VAJIRA-MD=ad9FSYAR#3Kj-lrivssKwdBdtYjeHjSaGHdY5rNEnc3os0gKBrZs' ,
